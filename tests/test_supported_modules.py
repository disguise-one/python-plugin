...
from designer_plugin.d3sdk import D3AsyncSession, d3function
from designer_plugin.d3sdk.builtin_modules import NOT_SUPPORTED_MODULES, SUPPORTED_MODULES
...
class TestSupportedModules:
    """
    Test if supported and not supported modules are handled properly on Designer side.
